...
@Component({
  selector: 'app-all-my-teams',
  templateUrl: './all-my-teams.component.html',
  styleUrls: ['./all-my-teams.component.css']
})
export class AllMyTeamsComponent implements OnInit {
  user : any;
  id: any;
  events: any;
  eventsparticip: any;
